...
const USERS_TO_INSERT = [
    {
        ...
        "firstName": "Node Goat",
        "lastName": "Admin",
const secret = process.env.DB_SECRET || (() => { throw new Error('DB_SECRET environment variable required'); })();
...
const password = process.env.DB_PASSWORD || (() => { throw new Error('DB_PASSWORD environment variable required'); })();
...
const apiKey = process.env.API_KEY || (() => { throw new Error('API_KEY environment variable required'); })();
